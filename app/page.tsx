...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <section className="w-full h-[764px] bg-cover bg-center relative" style={{ backgroundImage: "url('/products/home.svg')", opacity: 0.7 }}>
        <div className="container mx-auto px-4 h-full">
          <div className="flex items-center justify-between h-full relative z-10">
            
            <div className="flex-1 pr-8">
              <span className="text-pink text-base font-bold mb-3 block">Best e commerce For Your Castle....</span>
              <h1 className="text-4xl md:text-5xl font-bold text-[#0D0E43] mb-4">New  Trends in 2025</h1>
              <p className="text-[#2234d6] text-base mb-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Magna in est adipiscing in phasellus non in justo.</p>
